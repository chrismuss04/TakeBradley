...
public class GameEventFactory {
    ...
    public static ProjectileCreatedEvent createProjectileCreatedEvent() {
        return new ProjectileCreatedEvent();
    }

    // TODO: Update this method when Projectile class is implemented
